    ...
    template: `
        <app-docsectiontext>
            <p>
                ...
                migration between PrimeFlex to Tailwind CSS. For flawless migration, it is highly suggested to use VoxxUI v18 as the requirement of the tailwindcss plugin.
            </p>
