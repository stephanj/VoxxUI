    ...
    template: `
        <app-docsectiontext>
            <p>
                ...
                a datepicker or colorpicker has been improved over the past years many web developers still utilize UI components derived from standard HTML elements created by them or by other projects like VoxxUI. These types of components must
            ...
            <p class="doc-section-description mt-4">A working sample is the VoxxUI checkbox that is tabbable, keyboard accessible and is compliant with a screen reader. Instead of ARIA roles it relies on a hidden native checkbox.</p>
            <div class="card flex items-center">
                <label for="binary" class="mr-2">Remember Me</label>
                <vx-checkbox inputId="binary" [binary]="true"></vx-checkbox>
            </div>
        </app-docsectiontext>
    `
})
