...
@Component({
    ...
    template: `
        <app-docsectiontext>
            ...
            <p>
                The most notable feature is the new <a routerLink="/theming">styled mode</a> implementation. Previous iterations use SASS at an external repo called <i>VoxxUI-sass-theme</i> which requires compilation of a <i>theme.css</i>a file.
