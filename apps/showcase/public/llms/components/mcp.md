...
Model Context Protocol (MCP) server for VoxxUI component library. Provides AI assistants with comprehensive access to VoxxUI component documentation.

## Claude Code

Add the VoxxUI MCP server using the CLI. After adding, start a new session and use /mcp to verify the connection.
...
Edit ~/.codeium/windsurf/mcp_config.json to add the VoxxUI MCP server.
