...
import { BlockUIModule } from 'voxx-ui/blockui';
...
@Component({
    template: `
        <div class="card">
            <vx-button label="Block" (click)="blockedPanel = true" class="me-2" severity="secondary" />
            <vx-button label="Unblock" (click)="blockedPanel = false" severity="secondary" />
            <vx-blockui [target]="pnl" [blocked]="blockedPanel" />
            <vx-panel #pnl header="Header" class="mt-6">
                <p class="m-0">
...
@Component({
    template: `
        <div class="card">
            <vx-blockui [blocked]="blockedDocument" />
            <vx-button label="Block" (click)="blockDocument()" />
        </div>
    `,
    standalone: true,
