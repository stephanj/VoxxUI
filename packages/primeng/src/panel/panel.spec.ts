...
describe('Panel', () => {
    ...
    describe('Keyboard Navigation', () => {
        it('should toggle on Enter key', async () => {
            ...
            vi.spyOn(panelInstance, 'toggle').mockReturnValue(undefined);
    ...
    describe('Tab Index Management', () => {
        it('should call updateTabIndex when collapsed state changes', () => {
            ...
            vi.spyOn(panelComp, 'updateTabIndex').mockReturnValue(undefined);
    ...
    describe('Public Methods', () => {
        ...
        it('should call updateTabIndex when expanding', () => {
            vi.spyOn(panelInstance, 'updateTabIndex').mockReturnValue(undefined);
            panelInstance.expand();
